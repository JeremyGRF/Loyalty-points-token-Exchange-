...
def get_gift(w3):
    ...
    for number in range(len(gift)):
        ...
        st.write("Delta Reward Point per gift: ", db_list[number][3], "DLTA")
        st.text(" \n")
...
st.markdown("# Delta Reward List")
st.markdown("## Exchange Reward With Delta Token")
st.text(" \n")
...
st.sidebar.markdown("## Total Delta Reward Points")
